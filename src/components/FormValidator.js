export default class FormValidator {
  constructor(config, formValidate) {
    ...
    this._inputList = Array.from(
      this._formValidate.querySelectorAll(this._inputSelector)
    );
    this._submitButtonElement = this._formValidate.querySelector(
  ...
  _hideInputError(inputElement) {
    const errorElement = this._formValidate.querySelector(
